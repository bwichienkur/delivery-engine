    ...
    public sealed class CreateBatchLeadFile : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            if (batchFileDefinition.FileNameRegExp.Equals("EDDYLeads-(MM-dd-yyyy-hhmmss)"))
                fileName = GetFileName("EDDY_Leads_{0:MM-dd-yyyy-hhmmss}", batchFileDefinition.FileExtension, dateTime);
            else fileName = GetFileName(batchFileDefinition.FileNameRegExp, batchFileDefinition.FileExtension, dateTime);
        ...
        private static string GetFileName(string fileRegex, string fileExtension, DateTime dateTime)
        {
            ...
            if (String.IsNullOrEmpty(fileRegex)) fileRegex = "EDDY_Leads_{0:MM-dd-yyyy-hhmmss}";
