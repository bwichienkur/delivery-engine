...
namespace EDDY.IS.DeliveryEngine.Workflow.Activities
{
    public sealed  class LogInstantEmailPreviewSuccessful:CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            //Log Failed Post
            bool logSuccess = DeliveryEngineDataService.DeliveryEngineDAO.LogPreviewDeliveryComplete(leadData.LeadId,endpoint.DeliveryDefinitionId, emailBody, endpoint.EndpointDetailXML, true, DateTime.Now, 0, null, null, machineKey, 1);
