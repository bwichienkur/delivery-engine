...
namespace EDDY.Nexus.BusinessComponent.DeliveryEngine.Activities
{
    public sealed class LogSuccessfulPreviewPost : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            bool logSuccess = dao.LogPreviewDeliveryComplete(leadData.LeadId, endpoint.DeliveryDefinitionId, postData, endpoint.EndpointDetailXML, true, DateTime.Now , 0, serverResponse, postResponse, machineKey, 1);
