...
{
    public sealed class WriteToDELog : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                {
                    dao.TempLog(leadData != null ? leadData.LeadId : 0, deliveryEngineEventId, deliveryEndpointId,
                ...
                if (activityStepId > 0)
                {
                    IProductProcessingTransactionDAO pptDao = new ProductProcessingTransactionDAO();
                    pptDao.InsertTransactionDetail(leadData != null ? leadData.TransactionId.ToString() : new Guid().ToString(), activityStepId, message);
                }
            ...
            {
                dao.TempLog(leadData != null ? leadData.LeadId : 0, deliveryEngineEventId, deliveryEndpointId, ex.ToString(), 1, IsBeta);
            }
            WriteToDELogStatus.Set(context, true);
        }
    }
