...
namespace EDDY.Nexus.BusinessComponent.DeliveryEngine.Activities
{
    public sealed class LogInstantEmailSuccessful : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            bool logSuccess = dao.LogRealtimeDeliveryComplete(leadData.LeadId, endpoint.DeliveryEndpointId, emailBody, endpoint.EndpointDetailXML, true, rdq.LastDeliveryAttemptDatetime, rdq.CurrentDeliveryAttempts, null, null, machineKey, 1, leadData.IsBeta, emailAddressesDelivered, 0, 0, 200);
